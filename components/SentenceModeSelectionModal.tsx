        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="text-center">
              <span className="block font-black text-2xl mb-2">Mevcut Kelimelerden Çalış</span>
              <span className="text-base font-bold opacity-70">Kelime listeni kullan</span>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-center">
              <span className="block font-black text-2xl mb-2">Yeni Cümlelerle Çalış</span>
              <span className="text-base font-bold opacity-70">Resim yükleyerek çalış</span>
            </div>
          </button>
        </div>
      </div>
